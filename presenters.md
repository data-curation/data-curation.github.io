...
### Sandra Sawchuk
As a User Experience & Engagement and Data Librarian at Mount Saint Vincent University and a member of the Portage Network’s Curation Expert Group, Sandra Sawchuk brings valuable experience in data curation and the creation of data curation training materials. Moreover, as a member of a smaller institution, she brings knowledge of the challenges faced by universities without the resources to hire dedicated personnel for research data management. She holds Masters degrees in Humanities Computing and Information Studies from the University of Alberta.
